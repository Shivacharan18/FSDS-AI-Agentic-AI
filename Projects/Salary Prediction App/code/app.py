...
model = pickle.load(open(r"C:\Users\akiti\Linear_regressor_model.pkl", 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.This prediction app was developed by E.Balashiva Charan Reddy   ")
